...
export const LOGROS_ES: Record<string, TextoLogro> = {
  ...
  sin_marcar: { nombre: 'SIN MARCAR', descripcion: 'El rival no consigue ni un punto en todo el roll' },
  de_vuelta: { nombre: 'DE VUELTA', descripcion: 'Te montan o te toman la espalda, y acabas ganando' },
